...
export default function AboutPage() {
  ...
  return (
    <main>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16 lg:gap-20">
              ...
              <div className="w-full lg:w-1/2 lg:pt-12">
                <div className="space-y-8">
                  <div>
                    <h4 className="text-[#D4AF37] uppercase tracking-wider text-sm font-semibold mb-3 font-['Raleway']">Our Commitment</h4>
                    <h2 className="font-['Playfair_Display'] text-3xl md:text-[2.5rem] font-bold text-[#0F4C81] mb-6 leading-[1.2]">
                      Crafting Meaningful Sri Lankan Journeys Since 2010
                    </h2>
                    
                    <div className="w-20 h-1 bg-[#D4AF37] mb-8"></div>
                    
                    <p className="font-['Raleway'] text-gray-600 text-lg leading-relaxed mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                    <div className="bg-gray-50 p-6 rounded-xl hover:shadow-md transition duration-300">
                      <div className="w-12 h-12 rounded-full bg-[#D4AF37]/20 flex items-center justify-center text-[#0F4C81] mb-4">
                      ...
                      <h3 className="font-['Playfair_Display'] text-xl font-semibold text-[#0F4C81] mb-2">Local Expertise</h3>
                      <p className="text-gray-600">Our guides offer insider knowledge and personal connections that transform good trips into unforgettable journeys.</p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl hover:shadow-md transition duration-300">
                      ...
                      <h3 className="font-['Playfair_Display'] text-xl font-semibold text-[#0F4C81] mb-2">Personalized Care</h3>
                      <p className="text-gray-600">From meticulous planning to 24/7 support during your journey, we ensure every detail is perfectly handled.</p>
                    </div>
                  </div>
                  
                  <div className="pt-6">
                    <Link href="/tours" className="font-['Raleway'] inline-flex items-center px-8 py-3 bg-[#0F4C81] text-white hover:bg-[#0F4C81]/90 rounded-lg transition-colors duration-300 font-medium shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-white p-8 rounded-lg shadow-sm text-center h-full flex flex-col hover:shadow-md transition-shadow duration-300">
                <div className="w-16 h-16 rounded-full bg-[#D4AF37]/20 flex items-center justify-center mx-auto mb-6 text-[#0F4C81]">
                  {value.icon === 'fa-gem' && (
                ...
                <h3 className="font-['Playfair_Display'] text-xl font-semibold text-[#0F4C81] mb-3">{value.title}</h3>
                <p className="text-gray-600 flex-grow font-['Raleway']">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="relative py-20 bg-[#0F4C81]">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/tours" 
                className="inline-flex items-center justify-center px-8 py-3 bg-white text-[#0F4C81] hover:bg-gray-100 rounded-lg transition-colors duration-300 font-medium shadow-md hover:shadow-lg"
              >
